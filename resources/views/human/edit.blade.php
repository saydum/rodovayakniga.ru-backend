...
@section('content')
    ...
    <form action="{{ route("humans.update", $human->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3 pt-4">
            <h5>И.О.Ф</h5>
            <div class="col">
                <input type="text" class="form-control" name="name" placeholder="Имя" aria-label="Имя" value="{{ $human->name }}">
            </div>
            <div class="col">
                <input type="text" class="form-control" name="o_name" placeholder="Отчество" aria-label="Отчество" value="{{ $human->o_name }}">
            </div>
            <div class="col">
                <input type="text" class="form-control" name="f_name" placeholder="Фамилия" aria-label="Фамилия" value="{{ $human->f_name }}">
            </div>
        </div>
            ...
            <div class="col mb-3">
                ...
                <select class="form-select" aria-label="РОД" name="father_id">
                    ...
                    @foreach($mans as $human)
                        <option value="{{ $human->id }}">{{ $human->name . " " . $human->o_name . " " . $human->f_name}}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="row g-3 pt-4">
            ...
            <div class="col mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="nationality" id="nationality" value="{{ $human->nationality }}">
                </div>
            </div>
        </div>
                ...
                <div class="accordion-body">
                    ...
                    <div class="row g-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="location_birth" id="location_birth" value="{{ $human->location_birth }}">
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="number" class="form-control" name="height" id="height" value="{{ $human->height }}">
                        </div>
                        <div class="col">
                            <label for="eye_color" class="pb-1">Цвет глаз</label>
                            <input type="text" class="form-control" name="eye_color" id="eye_color" value="{{ $human->eye_color }}">
                        </div>
                        <div class="col">
                            <label for="hair_color" class="pb-1">Цвет волос</label>
                            <input type="text" class="form-control" name="hair_color" id="hair_color" value="{{ $human->hair_color }}">
                        </div>
                    </div>
